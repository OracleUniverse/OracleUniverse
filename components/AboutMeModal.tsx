        ...
        <div className="pt-16 sm:pt-20 pb-8 sm:pb-10 px-6 sm:px-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <a href="#" className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center bg-[#1877F2]/10 rounded-xl text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all">
                <i className="fab fa-facebook-f text-base sm:text-lg"></i>
              </a>
              <a href="https://youtube.com/@oracle-universe?si=nCN9JzTTuPf2MVh1" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center bg-[#FF0000]/10 rounded-xl text-[#FF0000] hover:bg-[#FF0000] hover:text-white transition-all">
