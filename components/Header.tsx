              ...
              <div className="flex items-center gap-3">
                ...
                <div className={`rounded-full p-2 flex items-center gap-2 transition-all duration-300 ${scrolled ? 'bg-slate-100/50 dark:bg-slate-800/50' : 'glass-pill'}`}>
                  <button
                    ...
                    className="w-11 h-11 flex items-center justify-center rounded-full text-slate-500 dark:text-slate-400 hover:text-oracle-red hover:bg-white dark:hover:bg-slate-700 transition-all duration-300"
                    title="Search"
                  >
                  ...
                  <button
                    ...
                    className={`w-11 h-11 flex items-center justify-center rounded-full transition-all duration-300 ${activeView === 'about' ? 'bg-oracle-red text-white shadow-lg' : 'text-slate-500 dark:text-slate-400 hover:text-oracle-red hover:bg-white dark:hover:bg-slate-700'}`}
                    title="About Author"
                  >
